...
const checkTheme = () => {
    ...
    if (theme == "light") {
        if (img) {
            window.location.href.split("/").reverse()[0] == "index.html" ? imgSrc = "./public/icons/sun.svg" : imgSrc = "../../../public/icons/sun.svg"
            img.src = imgSrc;
        }
        ...
        if (img) {
            window.location.href.split("/").reverse()[0] == "index.html" ? imgSrc = "./public/icons/moon-stars.svg" : imgSrc = "../../../public/icons/moon-stars.svg"
            img.src = imgSrc
        }
